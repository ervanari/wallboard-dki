        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="flex flex-row justify-between items-center p-2">
            <div className="relative group">
              ...
              <div className="text-xs text-black">{asa}</div>
            </div>
          ...
          <div className="flex flex-row justify-between items-center p-2">
            <div className="relative group">
              ...
              <div className="text-xs text-black">{acd}</div>
            </div>
          ...
          <div className="flex flex-row justify-between items-center p-2">
            <div className="relative group">
              ...
              <div className="text-xs text-black">{acw}</div>
            </div>
            <div className={`px-2 py-0.5 rounded-full bg-red-200`}>
          ...
          <div className="flex flex-row justify-between items-center p-2">
            <div className="relative group">
              ...
              <div className="text-xs text-black">{aht}</div>
            </div>
